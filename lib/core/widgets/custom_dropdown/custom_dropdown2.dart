...
// class CustomDropdown2<T extends DropdownItem> extends StatelessWidget {
//   final int? selectedId; // ⭐ Usar ID
//   final List<T> items;
//   final String? label;
//   final String hint;
//   final String? errorText;
//   final ValueChanged<int?>? onChanged; // ⭐ Retornar ID
...
//           CircleAvatar(
//             radius: avatarRadius,
//             backgroundColor: item.isActive ? activeColor : inactiveColor,
//             child: Text(
